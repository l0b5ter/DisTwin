...
Oki, lets start setting up the twitch bot. To allow the bot into the chat it needs an twitch account to interact with. You can use your own (streamers account) or create one specific for this use, the only important thing to remember is that it needs moderator perm. So in another word it needs mod perms, these perms are called [**scopes**](https://github.com/l0b5ter/DisTwin/blob/main/README.md#scopes).

1. "Bot username" this is simply the account username of which twitch account your using. In my chase this is loster31345.

2. "Bot authentication" this is alittle more tricky, because its not your password. You must allow scripts to run on the account to get your token. There are severals ways to obtain this token, but below are a some suggested ones and what [**scopes**](https://github.com/l0b5ter/DisTwin/blob/main/README.md#scopes) you will get.
   - ("https://twitchapps.com/tmi/") : Will give the most basic [**scopes**](https://github.com/l0b5ter/DisTwin/blob/main/README.md#scopes), which is ["chat:edit", "chat:read", "openid", "viewing_activity_read", "whispers:edit", "whispers:read"]. You cant manage reedemables, ads, subs etc. with this one! 
   - ("https://twitchtokengenerator.com/") : Lets you decide what [**scopes**](https://github.com/l0b5ter/DisTwin/blob/main/README.md#scopes) you wanna use! Under each section im gonna mention which [**scopes**](https://github.com/l0b5ter/DisTwin/blob/main/README.md#scopes) that are required.
...
#### Twitch
``Require ["chat:edit", "chat:read", "openid", "viewing_activity_read"]``
