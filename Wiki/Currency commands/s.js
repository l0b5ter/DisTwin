...
const fs = require('fs');
const rawKeys = 'a p e f.:.t shift.:.q';
var Keys = rawKeys.split(' ');
...
{
item.price = (parseInt(item.price) - parseInt('45')).toString();
...
module.exports.help = {
name: 's',
desc: 'Pay 45 to display Does this work? and click a p e f.:.t shift.:.q'
};